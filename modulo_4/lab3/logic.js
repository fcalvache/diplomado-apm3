...
*/
exports.page = function(title, nabvar, content){  // titulo, menu y un contenido
	...
	*/
	...
	.replace('{title}', title, 'g') // el g es global para que lo reemplace en la pagina
...
*/
exports.loadParameters = function(req, res, next){  //esto es para ponerlo visible a los demas
